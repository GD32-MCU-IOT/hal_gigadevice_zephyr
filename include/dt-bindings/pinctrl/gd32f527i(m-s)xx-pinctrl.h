...
/* EXMC_INT2 */
#define EXMC_INT2_PG6 \
	GD32_PINMUX_AF('G', 6, AF12)

/* EXMC_INT3 */
#define EXMC_INT3_PG7 \
...
#define RTC_TAMP0_PC13 \
	GD32_PINMUX_AF('C', 13, ANALOG)
#define RTC_TAMP0_PI8 \
	GD32_PINMUX_AF('I', 8, ANALOG)

/* RTC_TAMP1 */
#define RTC_TAMP1_PI8 \
	GD32_PINMUX_AF('I', 8, ANALOG)
...
/* SAI0_SD_0 */
#define SAI0_SD_0_PB2 \
	GD32_PINMUX_AF('B', 2, AF6)
#define SAI0_SD_0_PC1 \
	GD32_PINMUX_AF('C', 1, AF6)
#define SAI0_SD_0_PD6 \
...
#define SPI0_SCK_PC13 \
	GD32_PINMUX_AF('C', 13, AF5)
...
#define SPI5_NSS_PG4 \
	GD32_PINMUX_AF('G', 4, AF13)
#define SPI5_NSS_PG8 \
	GD32_PINMUX_AF('G', 8, AF5)

/* SPI5_SCK */
#define SPI5_SCK_PD10 \
	GD32_PINMUX_AF('D', 10, AF13)
...
#define TIMER7_CH2_PG1 \
	GD32_PINMUX_AF('G', 1, AF3)
...
#define TIMER7_CH3_PE1 \
	GD32_PINMUX_AF('E', 1, AF3)
#define TIMER7_CH3_PI2 \
	GD32_PINMUX_AF('I', 2, AF3)

/* TIMER7_CH3_ON */
#define TIMER7_CH3_ON_PD1 \
...
#define USART2_RX_PD15 \
	GD32_PINMUX_AF('D', 15, AF7)
